//Created by Hemerson Rafael on 25/03/16.
    ...
    do{
        ...
        while(cont==0||cont==4){
            ...
            if(test>e){
                cont=4;
                if(cont1==ni){
                    printf("O N. MAXIMO DE INTERACOES  E %d, NAO E POSSIVEL CONTINUAR!",ni);
                    cont=6;
                }
            }
